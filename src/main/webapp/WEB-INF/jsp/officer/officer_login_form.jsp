...
<table class="text">
    <tr>
        ...
        <td class="rightcol">
            <a th:href="@{/login_taxofficer?lang=en}">English</a>
            &nbsp;|&nbsp;
            <a th:href="@{/login_taxofficer?lang=uk}">Ukrainian</a>
        </td>
    </tr>
</table>
<div class="col-md-8 col-md-offset-2">
    <h1 th:text="#{officer.login.form}">Login form's Main</h1>
</div>
<div class="container" style="margin-top: 60px">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <form action="/officer_report_list">
...
<script type="text/javascript" src="/js/off_log_form.js"></script>
</body>
</html>
