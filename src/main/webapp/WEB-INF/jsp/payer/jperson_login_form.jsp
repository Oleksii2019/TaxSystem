...
<table class="text">
    <tr>
        ...
        <td class="rightcol">
            <a th:href="@{/login_juridical_person?lang=en}">English</a>
            &nbsp;|&nbsp;
            <a th:href="@{/login_juridical_person?lang=uk}">Ukrainian</a>
        </td>
    </tr>
</table>
<div class="col-md-8 col-md-offset-2">
    <h1 th:text="#{jperson.login.form}">Login form's Main</h1>
</div>
...
<script type="text/javascript" src="/js/jp_log_form.js"></script>
</body>
</html>